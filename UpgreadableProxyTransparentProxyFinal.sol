...
// proxy admin, to call repeated functions from proxy
...
contract Proxy {
    ...
    function changeAdmin(address _admin) external { // missing isAdmin modifier
        _setAdmin(_admin);
    }
...
contract ProxyAdmin {
    ...
    function getProxyAdmin(address proxy) external view returns (address) {
        // call a function that is not readOnly by using StaticCall
